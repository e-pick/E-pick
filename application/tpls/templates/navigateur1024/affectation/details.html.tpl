...
{/if}
	...
	<div class="lienhaut">
		<div class="liendroite">
			...
			{if $userLevel > 1 && $preparation->getEtat() == 1 || $preparation->getEtat() == 2}<a href="{$application_path}affectation/reinitialiser/{$preparation->getIdpreparation()}" onclick="return confirm('{$txt_confirmReinit}')">{$txt_reinitialiserPreparation}</a> | {/if}
