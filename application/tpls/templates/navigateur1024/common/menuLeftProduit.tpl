	...
	<div class="itemMenu">
		...
		<div class="itemSousMenu"> 
			...
			<div class="item">
				...
				<div id='blocRight'>
					<a href="{$application_path}geolocalisation/exporter" title=""><img src="{$application_path}images/{$user_template}/liste.png" alt="liste" /></a>
				</div>
				<div style="clear:both;"></div>
			</div>
	...
	<div class="itemMenu">
		...
		<div class="itemSousMenu"> 
			...
			<div class="item">
				<h5>{$menu_stats}</h5>
				<div id='blocRight'>
					<a href="{$application_path}admin/stats" title=""><img src="{$application_path}images/{$user_template}/liste.png" alt="liste" /></a>
				</div>
				<div style="clear:both;"></div>
			</div>
