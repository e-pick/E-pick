...
<div class="gauche">
	<div class="gauche inside">{$txt_commande_archive} : </div>
	<div class="droite inside">{$array_commande_archivee[$commande->getArchiveCommande()]}<!--&nbsp;&nbsp;({if $commande->getArchiveCommande() == "0"}<a href="#" title="">Archiver</a>){/if}--></div>
</div>
<div class="droite">
	<div class="gauche inside">&nbsp;&nbsp;</div>
	<div class="droite inside"></div>
</div>
<div class="gauche">
