...
function doubleConfirm(){
	var check1=confirm("Attention, vous allez perdre toute la mod\351lisation, \352tes vous certain de ce choix?");
	if (check1)
	{
		var check2=confirm("La mod\351lisation va \352tre totalement supprim\351e! Merci de confirmer une nouvelle fois !");
		if (check2)
		{
			return true;
		}
