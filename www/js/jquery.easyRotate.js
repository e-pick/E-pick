			...
			return this.each(function() {
				...
				// else for Safari, Firefox, etc
					...
					// obj.setAttribute("style",   "-moz-transform:  " + matrix + 
														...
														// "; transform:  " + matrix + 
														// "; -o-transform: " + matrix + "");
					obj.setAttribute("style", "-webkit-transform: rotate("+deg+"deg); -moz-transform: rotate("+deg+"deg); -o-transform: rotate("+deg+"deg); -ms-transform: rotate("+deg+"deg); transform: rotate("+deg+"deg); ");
